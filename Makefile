CFLAGS := `pkg-config gtk+-3.0 speech-dispatcher gtksourceview-3.0 gtkspell3-3.0 --cflags` -MMD -MP -Wall
LDFLAGS := `pkg-config gtk+-3.0 speech-dispatcher gtksourceview-3.0 gtkspell3-3.0 --libs` -rdynamic
